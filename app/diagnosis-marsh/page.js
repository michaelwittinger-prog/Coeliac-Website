    ...
    <div className="bg-slate-50">
      ...
      <div className="relative container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto">
          {/* Page Header */}
          <div className="mb-12">
            <div className="inline-flex items-center space-x-2 bg-blue-500/10 text-blue-400 px-3 py-1.5 rounded-md text-sm font-medium mb-4 border border-blue-500/20">
            ...
            <p className="text-lg text-slate-300 leading-relaxed">Understanding testing and damage classification</p>
          </div>
          ...
          <div className="bg-slate-800/50 backdrop-blur-sm rounded-lg p-8 shadow-lg border border-slate-700/50 mb-8">
            <div className="flex items-center space-x-3 mb-6">
              ...
              <h2 className="text-2xl font-bold text-white">Diagnostic Process</h2>
            </div>
            <div className="space-y-6">
              {diagnosticSteps.map((step) => (
                <div key={step.number} className="flex items-start space-x-4">
                  <div className="flex-shrink-0 w-10 h-10 bg-blue-600 rounded-lg flex items-center justify-center shadow-lg">
